...
MANDATORY: run after ANY diagram add or edit (see PROJECT.md).
    python3 scripts/svg_lint.py [file.html ...]     (default: html-guide/sections/*.html)
...
if __name__ == '__main__':
    ...
    files = sys.argv[1:] or sorted(glob.glob(__import__('os').path.join(_root, 'html-guide/sections/*.html')))
    sys.exit(main(files))
