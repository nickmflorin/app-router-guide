...
- [Streaming (guide)](https://nextjs.org/docs/app/guides/streaming) - the two streams, static shell,
  promise-passing, HTTP contract, vitals, and buffering pitfalls; source for the §11.2 deep
  subsections; companion demo at streaming-demo.labs.vercel.dev.
...
- [Beyond React 16 (Dan Abramov, JSConf Iceland 2018)](https://www.youtube.com/watch?v=nLF0n9SACd4) -
  the talk that introduced Suspense; the version-control analogy (~29:00) is rendered as the
  four-frame diagram in §10.1.
...
- [requestIdleCallback (MDN)](https://developer.mozilla.org/en-US/docs/Web/API/Window/requestIdleCallback) -
  the idle gate behind §6's deferred client twin query.
