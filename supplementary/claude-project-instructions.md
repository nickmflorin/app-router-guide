...
- Diagrams in the markdown are Mermaid conversions of the original SVG figures: faithful in
  content, approximate in appearance. The HTML file is authoritative when they seem to differ.
